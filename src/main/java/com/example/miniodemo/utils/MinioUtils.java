package com.example.miniodemo.utils;
...
public class MinioUtils {
    ...
    public String getPolicyUrl(String objectName, Method method, int time, TimeUnit timeUnit) {
        try {
            ...
            e.printStackTrace();
        } catch (ServerException | java.security.InvalidKeyException e) {
            e.printStackTrace();
        }
        return null;
    }
    ...
    public void upload(MultipartFile file, String fileName) {
        ...
        try {
            ...
            e.printStackTrace();
        } catch (XmlParserException | java.security.InvalidKeyException e) {
            e.printStackTrace();
        }
    }
